public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        int str = new Solution().calculateStringPeriod("ababababababababa");
        System.out.println("Result is " + str);
        System.out.println(new Solution().calculateStringPeriod("abcdabcdabcd"));
        System.out
        ...
        System.out.println(new Solution().calculateStringPeriod("abcd1abcd2abcd"));
